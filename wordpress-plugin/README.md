...
Generates complete, production-ready WordPress plugins from scratch — enterprise-grade structure, full security guardrails, internationalization, and a complete uninstall script. Seven-question multiple-choice intake (five MC + two free-text) drives every file in the output tree.

Part of the [`chrismccoy-skills`](../README.md) Claude Code marketplace. Full description and usage examples in the [marketplace root README](../README.md#wordpress-plugin).
...
└── SKILL.md                                 ← seven-question intake + file generation rules + security/standards/uninstall
```

## How it works

1. **Seven-question intake** — five multiple-choice via `AskUserQuestion` plus two free-text:
...
GPL-2.0-or-later — same as the rest of the marketplace and the WordPress ecosystem the generated plugins ship into.
