...
Part of the [`chrismccoy-skills`](../README.md) Claude Code marketplace. Full description, categorized style list, usage examples, and "what each style spec includes" in the [marketplace root README](../README.md#html-design-styles).
